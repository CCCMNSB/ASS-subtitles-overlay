...
A **Tampermonkey userscript** that overlays local subtitle files on web videos (Bilibili, YouTube, etc.).
...
一个 **Tampermonkey 油猴脚本**，在网页视频（B站、YouTube 等）上叠加本地字幕文件，可多说话人同时显示，并保留 ASS 原始颜色与位置。
